            ...
            <div className='dashboard-transfer center-content'>
                <Form>
                    <div className='dashboard-transfer-inputs'>
                        <div>
                            <h2>{strings.missceleneous.buy}</h2>
                        ...
                        <div>
                            <h2>{strings.missceleneous.sell}</h2>
                            {strings.fields.currency}:
                            <Form.Field >
                                <Dropdown fluid selection options={this.state.fakeCurrencies} />
                            </Form.Field>
                    ...
                    <div className='form-inputs'>
                        <Form.Field>
                            <Button className='purple-button'>{strings.buttons.exchange}</Button>
                        </Form.Field>
                    </div>
                </Form>
            </div>
...
export default connect(null, null)(Exchange);